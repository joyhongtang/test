package com.idwell.cloudframe.widget.banner;
...
import com.idwell.cloudframe.widget.banner.config.BannerConfig;
import com.idwell.cloudframe.widget.banner.listener.OnBannerListener;
import com.idwell.cloudframe.widget.banner.listener.OnPageChangeListener;
import com.idwell.cloudframe.widget.banner.util.BannerUtils;
...
//    }
    ...
    public Banner setBannerHeight(int height) {
        setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, (int) BannerUtils.dp2px(height)));
        return this;
    }

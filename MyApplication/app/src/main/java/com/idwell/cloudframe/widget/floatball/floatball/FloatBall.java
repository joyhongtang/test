...
import com.idwell.cloudframe.widget.floatball.runner.OnceRunnable;
import com.idwell.cloudframe.widget.floatball.runner.ScrollRunner;
import com.idwell.cloudframe.widget.floatball.utils.MotionVelocityUtil;
...
public class FloatBall extends FrameLayout implements ICarrier {
    ...
    private void init(Context context) {
        ...
        imageView.setImageResource(R.drawable.ic_float_ball);
        mSize = mConfig.mSize;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                imageView.setImageResource(R.drawable.ic_float_ball_pressed);
                touchDown(x, y);
                break;
    ...
    private void moveToEdge(boolean smooth, boolean forceSleep) {
        ...
        if (mLayoutParams.x < centerX) {
            ...
            destX = sleep ? screenWidth - halfWidth * 2 : screenWidth - width;*/
    ...
    private void onMove(int deltaX, int deltaY) {
        if (Device.isDualScreen && mLayoutParams.x + deltaX + getWidth() > floatBallManager.mScreenWidth) return;

package com.idwell.cloudframe.widget.switchtextview;
...
public class SwitchTextView extends View implements View.OnClickListener {
    ...
    private void init(@Nullable AttributeSet attrs) {
        // 获取自定义属性
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SwitchTextView);
        bgColor = a.getColor(R.styleable.SwitchTextView_bgColor, rgb);
        leftColor = String.valueOf(a.getColor(R.styleable.SwitchTextView_leftColor, Color.rgb(34, 139, 34)));
        rightColor = String.valueOf(a.getColor(R.styleable.SwitchTextView_rightColor, Color.rgb(34, 139, 34)));
        textLeftColor = String.valueOf(a.getColor(R.styleable.SwitchTextView_textLeftColor, Color.rgb(0, 0, 0)));
        textRightColor = String.valueOf(a.getColor(R.styleable.SwitchTextView_textRightColor, Color.rgb(0, 0, 0)));
        textLeftClickColor = String.valueOf(a.getColor(R.styleable.SwitchTextView_textLeftClickColor, rgb));
        textRightClickColor = String.valueOf(a.getColor(R.styleable.SwitchTextView_textRightClickColor, rgb));
        checked = a.getBoolean(R.styleable.SwitchTextView_setChecked, false);//false left , true right
        textLeft = a.getString(R.styleable.SwitchTextView_textLeft);
        textRight = a.getString(R.styleable.SwitchTextView_textRight);
        padding = a.getDimension(R.styleable.SwitchTextView_padding, dp2px(4));
        time = a.getInteger(R.styleable.SwitchTextView_time, 300);
        a.recycle();
    }
    ...
    private void initPaint() {
        ...
        leftTextPaint.setTextSize(sp2px(32));
        leftTextPaint.setAntiAlias(true);
        rightTextPaint = new Paint();
        rightTextPaint.setTextSize(sp2px(32));
    ...
    public void setOnClickCheckedListener(SwitchTextView.onClickCheckedListener onClickCheckedListener) {

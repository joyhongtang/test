...
public class RecordActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener ,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FileUtil.init(this);
        initView();
        findViewById(R.id.record_control).postDelayed(new Runnable() {
            @Override
            public void run() {
                findViewById(R.id.record_control).performClick();
            }
        },500);
...
//        setProfile();
        ...
        //设置输出的文件路径
        String path  = FileUtil.newMp4File().getAbsolutePath();
        pathList.add(path);
    ...
    private void setConfig() {
        ...
        //设置最大录像时间 单位：毫秒
        mMediaRecorder.setMaxDuration(15 * 1000);
        //设置最大录制的大小60M 单位，字节
